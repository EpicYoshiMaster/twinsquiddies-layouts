		...
		<CommentatorBox>
			<CommentatorName>
				<CarouselComponent speed={10000} playing={playing}>
					<FittedText text={name} font="Genty Sans" align="left" maxWidth={pronouns !== "" ? nameWidth : fullWidth}  />
					{tag !== "" && <FittedText text={tag} font="Genty Sans" align="left" maxWidth={pronouns !== "" ? nameWidth : fullWidth}  />}
				</CarouselComponent>
			</CommentatorName>
			{pronouns !== "" && 
			<CommentatorPronouns>
				<FittedText text={pronouns} font="Genty Sans" align="left" maxWidth={pronounsWidth} />
			</CommentatorPronouns>
			}
		</CommentatorBox>
	)
